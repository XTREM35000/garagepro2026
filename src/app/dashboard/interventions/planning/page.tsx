...
export default function InterventionPlanningPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold mb-2">Planning Techniciens</h1>
        <p className="text-gray-600 dark:text-gray-400">Affectation des techniciens aux interventions</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-12 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <p className="text-gray-500">Planning non disponible</p>
      </div>
    </div>
  );
}
